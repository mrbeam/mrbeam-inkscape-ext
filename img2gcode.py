...
if __name__ == "__main__":
	...
	opts.add_option("-d", "--beam_diameter", type="float", help="laser beam diameter", default=0.25, dest="beam_diameter")
	opts.add_option("-s", "--speed", type="float", help="engraving speed", default=1000, dest="feedrate")
	opts.add_option("",   "--intensity-white", type="int", default="0", help="intensity for white pixels", dest="intensity_white")
	opts.add_option("",   "--intensity-black", type="int", default="1000", help="intensity for black pixels", dest="intensity_black")
